    ...
    <body>
        ...
        <span>
           ...
           <div class="rows">
            ...
            <div class="col-md-4">
               <form action="issue_book2.php" method="post">
                <div class="form-group">
                    <label>S_Number:</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="issued_date" class="form-control" value="<?php echo date("yy-m-d");?>"required>
                </div>
                 <div class="form-group">
                ...
                <button class="button" name="add_name">Issue Book</button>
               </form> 
            </div>
            <div class="col-md-4"></div>
        </div>
