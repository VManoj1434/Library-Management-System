           ...
           <div class="rows">
            ...
            <div class="col-md-4">
               <form action="" method="post">
                ...
                <button class="button" name="update" >Update Author</button>
               </form> 
            </div>
            <div class="col-md-4"></div>
        </div>
...
<?php
    if(isset($_POST['update'])){
        $connection = mysqli_connect("localhost", "root", "");
        $db = mysqli_select_db($connection,"keety");
        $query ="UPDATE `author` SET `author_id`='$_POST[author_id]',`author_name`='$_POST[author_name]' WHERE author_id=$_GET[aid]";
         $query_run=mysqli_query($connection,$query);
