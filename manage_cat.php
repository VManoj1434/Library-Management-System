                ...
                <table >
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ?><tr>
                                ...
                                <td> 
                            <button class="button" name="" style="background-color:white"><a href="edit_category.php?cid=<?php echo $row['cat_id'];?>">Edit</a></button>
                            <button class="button" name="" style="background-color: white"><a href="delete_category.php?cid=<?php echo $row['cat_id'];?>">Delete</a></button>
                        </td>
                    </tr>
                        <?php
                    }
