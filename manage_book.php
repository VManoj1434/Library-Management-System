                ...
                <table >
                    ...
                    while($row = mysqli_fetch_assoc($query_run)){
                        ?><tr>
                                ...
                                <td> 
                            <button class="button" name="" style="background-color:white"><a href="edit_book.php?bn=<?php echo $row['book_no']; ?>">Edit</a></button>
                            <button class="button" name="" style="background-color: white"><a href="delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button>
                        </td>
                    </tr>
                        <?php
                    }
